import { ItemSummary, PurchaseBillItem } from '../models/purchase-bill.models';
...
/** Item Summary: Total Items is the number of rows and Total Qty is the sum of their Qty fields. */
export function summarizeItems(items: readonly Pick<PurchaseBillItem, 'quantity'>[]): ItemSummary {
  return {
